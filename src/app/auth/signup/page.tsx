    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-slate-800 mb-2">Join the Research Community</h1>
          <p className="text-gray-600">Connect with fellow researchers and innovators</p>
        </div>
        ...
        <Card className="shadow-lg border-0">
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-center">
              Enter your details to get started with professional networking
            </CardDescription>
          </CardHeader>
          <CardContent>
